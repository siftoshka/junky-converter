...
class JunkRepositoryImpl(
    ...
    override suspend fun insertInitialJunks(junkNames: List<String>) {
        val junks = listOf(
            ...
            Junk(
                id = 10,
                name = junkNames[10],
                value = getSelectedJunk(10).value,
            ...
            Junk(
                id = 11,
                name = junkNames[11],
                value = getSelectedJunk(11).value,
            ...
            Junk(
                id = 12,
                name = junkNames[12],
                value = getSelectedJunk(12).value,
    ...
    override suspend fun getSelectedJunk(id: Int): Junk = junkDAO.getSelectedJunk(id)
