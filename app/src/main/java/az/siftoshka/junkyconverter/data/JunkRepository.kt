...
class JunkRepository @Inject constructor(private val junkDAO: JunkDAO) {
    ...
    suspend fun insertInitialJunks() {
        val junks = listOf(
            ...
            Junk(8, R.string.item_fried_chickens, 1.25f, R.drawable.ic_launcher_foreground, R.string.img_desc_item_fried_chickens),
            Junk(9, R.string.item_nuggets, 0.8f, R.drawable.ic_launcher_foreground, R.string.img_desc_item_nuggets)
        )
