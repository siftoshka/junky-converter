...
class JunkRepository @Inject constructor(private val junkDAO: JunkDAO) {
    ...
    suspend fun insertInitialJunks() {
        val junks = listOf(
            ...
            Junk(2, R.string.item_pizzas, icon = R.drawable.ic_launcher_foreground, iconDescription = R.string.img_desc_item_burgers),
            Junk(3, R.string.item_kebabs, icon = R.drawable.ic_launcher_foreground, iconDescription = R.string.img_desc_item_burgers),
            Junk(4, R.string.item_chips, icon = R.drawable.ic_launcher_foreground, iconDescription = R.string.img_desc_item_burgers),
            Junk(5, R.string.item_donuts, icon = R.drawable.ic_launcher_foreground, iconDescription = R.string.img_desc_item_burgers),
            Junk(6, R.string.item_tacos, icon = R.drawable.ic_launcher_foreground, iconDescription = R.string.img_desc_item_burgers),
            Junk(7, R.string.item_muffins, icon = R.drawable.ic_launcher_foreground, iconDescription = R.string.img_desc_item_burgers),
    ...
    suspend fun getAllJunks() = junkDAO.getAllJunks()
}